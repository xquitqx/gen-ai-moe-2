...
npx cdk bootstrap aws://571600842703/us-east-1 --force \
  --cloudformation-execution-policies arn:aws:iam::571600842703:policy/cdk-toolkit-jamal-least-privillege \
